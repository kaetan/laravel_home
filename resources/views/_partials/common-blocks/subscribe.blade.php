<div class="subscribe subscribe<?= !empty($subscribeClass) ? $subscribeClass : ''; ?>">
    <form action="#" class="subscribe__form subscribe__form<?= !empty($subscribeClass) ? $subscribeClass : ''; ?>">
