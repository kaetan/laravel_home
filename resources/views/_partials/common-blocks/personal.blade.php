<div class="personal jsDropdownContainer <?= !empty($personalClass) ? $personalClass : ''; ?>">
    <div class="personal__dropdown-link jsDropdownTrigger"><i class="personal__icon fas fa-user fa-2x"></i></div>
